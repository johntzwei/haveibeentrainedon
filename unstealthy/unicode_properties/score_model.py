...
from src.unstealthy.score import calculate_scores_unicode_properties

def main(args):
    print("entered main function!")
    calculate_scores_unicode_properties(**vars(args))
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=512,
        help="the max number of tokens that we are scoring on for UNICODE ONLY"
    )
