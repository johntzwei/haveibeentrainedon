...
#creates the jsonl file, and returnss the prop_inputs to be turned into a csv
def edit_json_unstealthy_scaling(orig_jsonl, new_jsonl, watermark, k, info):
    import json
...
def perturb_dataset(exp_name, **kwargs):
    ...
    if (exp_name == "unstealthy_scaling" or exp_name == "unstealthy_raretoken"):
        ...
        prop_inputs = edit_json_unstealthy_scaling(kwargs["raw_dataset"], out_jsonl, random_sequence, kwargs["repetition"],
