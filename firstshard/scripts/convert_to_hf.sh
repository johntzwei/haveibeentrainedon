...
python ${NEOX_DIR}/tools/convert_module_to_hf.py --input_dir ${MODEL_DIR}/perturb_model_1_percent/global_step2146/ --config_file ${CONFIG_DIR}/160M.yml --output_dir ${ANALYSIS_DIR}/perturb_model_1_percent/global_step_2146
