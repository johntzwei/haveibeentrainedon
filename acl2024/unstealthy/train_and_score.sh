...
WORKING_DIR=$NEOX_DIR/haveibeentrainedon/acl2024/unstealthy
MODEL_YML=70M.yml
...
python $NEOX_DIR/deepy.py $NEOX_DIR/train.py \
      -d $WORKING_DIR/configs $MODEL_YML local_setup.yml
...
papermill $WORKING_DIR/score_null.ipynb $WORKING_DIR/output.ipynb \
    ...
    -p output_fn $WORKING_DIR/data/frac:$frac/scores.csv
